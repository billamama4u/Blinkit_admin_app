...
import com.tarun.admin_blinkit.Models.Users
import com.tarun.admin_blinkit.ViewModel.AuthViewModels
import com.tarun.admin_blinkit.databinding.FragmentOtpBinding
            ...
            authViewModels.verfisuccess.collect {
                if(it){
                    ...
                    FirebaseMessaging.getInstance().token.addOnCompleteListener {
                        val token=it.result
                        users.token=token
                        FirebaseDatabase.getInstance().getReference("AllAdmin").child("Admininfo").child(users.uid!!).setValue(users)
                        Utils.hideDialogue()
